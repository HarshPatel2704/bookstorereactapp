...
function Navbar() {
    ...
    const navItems = (
        <>
            ...
            {/* <Link to='/contact' className='mt-2 cursor-pointer'> Contact</Link> */}
            <li><a>About</a></li>
        </>
        );
    return (
                ...
                <div className="navbar">
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 dark:bg-slate-500 dark:text-white">
                                {navItems}
                            </ul>
                        </div>
                    ...
                    <div className='navbar-end space-x-3'>
                        ...
                        {
                            <div>
                            <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-860 duration-300 cursor-pointer"
                                onClick={() =>
